...
Production rewrite of [טבע לי](https://elirancr24-max.github.io/teva-li/), the Israeli fresh-cut-fruit & event-kayak brand. Next.js 15 + TypeScript + Tailwind v4 + Supabase + Stripe + Resend.
...
| **9** | QA pass with `teva-li-tester`, Playwright e2e, launch |
...
- `teva-li-designer` — brutalist-editorial design reviewer. Invoke proactively after visual changes.
- `teva-li-tester` — QA reviewer for end-to-end flows. Invoke before each phase deploy.
...
The previous static bundle is preserved at `<repo-root>/teva-li-bundle.html` and remains live at https://elirancr24-max.github.io/teva-li/ until this Next.js app is feature-complete and deployed to Vercel under `teva-li.com`.
