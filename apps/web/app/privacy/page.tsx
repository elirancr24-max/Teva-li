...
export const metadata: Metadata = {
  ...
  description: 'מדיניות הפרטיות של אתר טבע לי — איזה מידע נאסף, איך הוא משמש, הבסיס החוקי לעיבוד, וזכויות הלקוח.',
};
        ...
        <Container maxWidth="md" sx={{ py: { xs: 5, md: 10 }, px: { xs: 2.5, md: 3 } }}>
          <Stack spacing={3}>
            ...
            <Section title="איזה מידע אנחנו אוספים">
              ...
              <p>
                <b>שמירת מידע:</b> נתוני הזמנות נשמרים <b>7 שנים</b> לצורכי מס וחשבונאות בהתאם לדרישות החוק.
                נתוני ניתוח שימוש (Vercel Analytics) הם מצטברים בלבד — ללא שמירת מידע מזהה אישי (PII).
              </p>
            </Section>

            <Section title="בסיס חוקי לעיבוד המידע">
              <p>
                עיבוד המידע האישי שלכם מתבצע על בסיס אחד מהבסיסים הבאים, בהתאם לסעיף 1 לחוק
                הגנת הפרטיות, תשמ&quot;א-1981:
              </p>
              <ul>
                <li>
                  <b>ביצוע חוזה</b> — עיבוד פרטי ההזמנה, המשלוח, והקשר עמכם הכרחי לביצוע הסכם
                  המכר בינינו.
                </li>
                <li>
                  <b>ציות לחוק</b> — שמירת חשבוניות ורישומי עסקאות נדרשת לפי פקודת מס הכנסה
                  וחוק מס ערך מוסף.
                </li>
                <li>
                  <b>אינטרס לגיטימי</b> — שימוש בנתוני שימוש אנונימיים מצטברים לשיפור השירות
                  והאתר, באופן שאינו פוגע בפרטיותכם.
                </li>
              </ul>
            </Section>
            ...
            <Section title="עוגיות (Cookies)">
              <p>
                האתר משתמש בעוגיות הכרחיות בלבד לתפעולו (סשן, סל קניות). בנוסף, אנחנו משתמשים
                ב-<b>Vercel Analytics</b> לניתוח שימוש — שירות זה <b>privacy-first</b>: אינו משתמש
                בעוגיות אישיות, אינו עוקב אחריכם בין אתרים, ואינו שומר מזהים אישיים. לפרטים נוספים
                ראו את <a href="/cookies">מדיניות העוגיות</a>.
              </p>
            </Section>

            <Section title="דיוור שיווקי">
              <p>
                אנחנו לא שולחים דיוור שיווקי ללא הסכמתך המפורשת. אם הסכמת ורוצה להסיר עצמך,
                שלח הודעה ל-<a href="mailto:orders@teva-li.com">orders@teva-li.com</a> עם הנושא
                &quot;הסרה מרשימת התפוצה&quot;, ואנחנו נסיר אותך תוך 3 ימי עבודה.
              </p>
            </Section>
            ...
            <Section title="הזכויות שלכם">
              <ul>
                ...
                <li>
                  <b>זכות הגשת תלונה</b> — אם אתם סבורים שהפרנו את זכויות הפרטיות שלכם, תוכלו
                  לפנות ל<b>רשות הגנת הפרטיות</b> במשרד המשפטים:{' '}
                  <a href="https://www.gov.il/he/departments/units/privacy-protection-authority" target="_blank" rel="noreferrer noopener">
                    www.gov.il — רשות הגנת הפרטיות
                  </a>.
                </li>
              </ul>
              <p>
